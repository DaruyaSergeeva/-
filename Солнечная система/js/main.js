...
window.onload = function () {
    ...
    const ui = new UI({ callbacks: { move, printPoints, printEdges, printPolygons, subjectOn } });
    ...
    function subjectOn(canSubjPrint, id) {
        if (canSubjPrint) {
            if (id === 'sunsistem') {
                SCENE = [
                    sur.sphera(40, 20, new Point(0, 0, 0), '#ffff00', {rotateOz : new Point(0, 0, 0)}),// солнце
                    sur.sphera(20, 6, new Point(55, -20, 0), '#00AF00', {rotateOz : new Point(0, 0, 0)}),// земля
                    sur.sphera(20, 1, new Point(65, -20, 0), '#FFFFE0', {rotateOz : new Point(0, 0, 0)}),// луна
                    sur.sphera(20, 10, new Point(-90, 0, 0), '#9370DB', {rotateOz : new Point(0, 0, 0)}),// сатурн
                    sur.bublik(15, 30, new Point(-90, 0, 0), '#FFE4C4', {rotateOz : new Point(0, 0, 0)}) // колечко сатурна
            ...
            if (id === 'sphera') {
                SCENE = [
                    sur.sphera(40, 20, new Point(0, 0, 0),'NULL', {rotateOz : new Point(0, 0, 0)} ),//сфера
                ];
            }
